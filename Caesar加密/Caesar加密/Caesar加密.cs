...
namespace Caesar加密
{
	public class 汉语拼音版Caesar加密
	{
		...
		//String[] 韵尾表_小写 = {"p", "t", "k", "m", "n", "ng", "e", "i", "r", "u", "ü"};		// 前3个为公认的汉语部分方言含有的“塞韵尾”；4th个为吴语|江浙话中简化后的“塞擦韵尾”；5th~7th既指大部分方言含有的3种“阳声韵韵尾”，也指普通话中含有的单独的鼻辅音字，如：“姆”、“呒”、“呣”、“唔”、“嗯”；“r”指儿化韵、“儿”的韵尾；余下为正常韵尾
		//
		// 通用版
